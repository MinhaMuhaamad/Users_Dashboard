...
export function MessageBubble({ message }: MessageBubbleProps) {
      ...
      if (urlRegex.test(part)) {
        ...
        return (
          <a
            ...
            className="text-blue-600 font-bold hover:underline break-all inline"
          >
            {part}
          </a>
        )
  ...
  if (!isOwn) {
    ...
    return (
      <div className="flex flex-col items-start mb-4 max-w-[80%] relative select-text">
        ...
        <div className="bg-[#F3F4F6] text-slate-800 text-xs px-4 py-3 rounded-2xl rounded-tl-none font-semibold leading-relaxed shadow-sm">
  ...
  return (
    <div className="flex flex-col items-end mb-4 max-w-[80%] ml-auto relative select-text">
      <div className="bg-[#EDE9FE] text-slate-900 text-xs px-4 py-3 rounded-2xl rounded-tr-none font-semibold leading-relaxed shadow-sm border border-purple-100/50">
        {renderMessageText(text)}
      </div>
